...
class Datasource() {
    ...
    fun loadFilms(): List<Film> {
        return listOf<Film>(
            Film(title = "Dune: Hành tinh cát - Phần Hai Hành Tinh Cát Phần hai Hành thinh", pictureUrl = "https://cinema.momocdn.net/img/12744539559079075-2wDBg6JcjhoWyw3LCy2k4XMHOBV.jpg", releaseDate = "08/03/2024", restrictAge = 16, tag = "Khoa học viễn tưởng, Phiêu lưu, Chính kịch, Hành động, Hài", ranking = Ranking(9.3f, 1800, 56, 21, 45, 141, 1507),  duration = 124, language = "Phụ đề Lồng Tiếng", description = "Hãy theo dõi hành trình thần thoại của Paul Atreides khi anh đoàn kết với Chani và Fremen trong khi trên con đường trả thù những kẻ âm mưu phá hoại gia đình anh. Đứng trước sự lựa chọn giữa tình yêu của đời mình và số phận của vũ trụ đã biết, Paul cố gắng ngăn chặn một tương lai khủng khiếp mà chỉ có anh mới có thể nhìn thấy", cast = loadCast()),
            Film(title = "Đào, phở và piano", pictureUrl = "https://cinema.momocdn.net/img/33735630744753025-jWYfucBwXG3ePh97bM5ReT1q65X.jpg", releaseDate = "14/06/2025", restrictAge = 18, tag = "Chính kịch", ranking = Ranking(9.3f, 1800, 56, 21, 45, 141, 1707), duration = 124, language = "Phụ đề", description = "Hãy theo dõi hành trình thần thoại của Paul Atreides khi anh đoàn kết với Chani và Fremen trong khi trên con đường trả thù những kẻ âm mưu phá hoại gia đình anh. Đứng trước sự lựa chọn giữa tình yêu của đời mình và số phận của vũ trụ đã biết, Paul cố gắng ngăn chặn một tương lai khủng khiếp mà chỉ có anh mới có thể nhìn thấy", cast = loadCast()),
            Film(title = "Kung Fu Panda 4", pictureUrl = "https://cinema.momocdn.net/img/33921126334732652-7quq3UOaaB0qNM7TMGMEqqghLck.jpg", releaseDate = "08/03/2024", restrictAge = 10, tag = "Gia đình, Hài, Hành động, Phiêu lưu, Hoạt hình", ranking = Ranking(9.3f, 1800, 56, 21, 45, 141, 1707), duration = 124, language = "Lồng Tiếng", description = "Hãy theo dõi hành trình thần thoại của Paul Atreides khi anh đoàn kết với Chani và Fremen trong khi trên con đường trả thù những kẻ âm mưu phá hoại gia đình anh. Đứng trước sự lựa chọn giữa tình yêu của đời mình và số phận của vũ trụ đã biết, Paul cố gắng ngăn chặn một tương lai khủng khiếp mà chỉ có anh mới có thể nhìn thấy", cast = loadCast()),
            Film(title = "MAI", pictureUrl = "https://cinema.momocdn.net/img/30196263872528348-thumb.jpg", releaseDate = "11/12/2024", restrictAge = 13, tag = "Hài", ranking = Ranking(9.3f, 1800, 56, 21, 45, 141, 1707), duration = 89, language = "Phụ đề Lồng Tiếng", description = "Hãy theo dõi hành trình thần thoại của Paul Atreides khi anh đoàn kết với Chani và Fremen trong khi trên con đường trả thù những kẻ âm mưu phá hoại gia đình anh. Đứng trước sự lựa chọn giữa tình yêu của đời mình và số phận của vũ trụ đã biết, Paul cố gắng ngăn chặn một tương lai khủng khiếp mà chỉ có anh mới có thể nhìn thấy", cast = loadCast()),
            Film(title = "MAI", pictureUrl = "https://cinema.momocdn.net/img/30196263872528348-thumb.jpg", releaseDate = "01/01/2024", restrictAge = 18, tag = "Chính kịch, Hành động", ranking = Ranking(9.3f, 1800, 56, 21, 45, 141, 1707), duration = 123, language = "Lồng Tiếng", description = "Hãy theo dõi hành trình thần thoại của Paul Atreides khi anh đoàn kết với Chani và Fremen trong khi trên con đường trả thù những kẻ âm mưu phá hoại gia đình anh. Đứng trước sự lựa chọn giữa tình yêu của đời mình và số phận của vũ trụ đã biết, Paul cố gắng ngăn chặn một tương lai khủng khiếp mà chỉ có anh mới có thể nhìn thấy", cast = loadCast()),
            Film(title = "MAI", pictureUrl = "https://cinema.momocdn.net/img/30196263872528348-thumb.jpg", releaseDate = "30/05/2024", restrictAge = 1, tag = "Chính kịch, Hành động, Hài", ranking = Ranking(9.3f, 1800, 56, 21, 45, 141, 1707), duration = 195, language = "Phụ đề", description = "Hãy theo dõi hành trình thần thoại của Paul Atreides khi anh đoàn kết với Chani và Fremen trong khi trên con đường trả thù những kẻ âm mưu phá hoại gia đình anh. Đứng trước sự lựa chọn giữa tình yêu của đời mình và số phận của vũ trụ đã biết, Paul cố gắng ngăn chặn một tương lai khủng khiếp mà chỉ có anh mới có thể nhìn thấy", cast = loadCast())
